...
<div class="page-content d-flex justify-content-center">
    ...
    <div class="row profile-body col-md-10 col-lg-8">
        <div class="middle-wrapper">
            <div class="row d-flex justify-content-center">
                <div class="card blog-card order-card-wrapper">
                    <div class="card-body order-card-body my-5">

                        <h6 class="blog-title">Order Your Pizza</h6>
                 <form id="myForm" method="POST" action="{{ route('pizzas.store.order') }}" class="forms-sample">
                    @csrf
