            ...
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.profile.store') }}"  class="forms-sample" >
                    ...
                    <div class="mb-3">
                        ...
                        <input name="phone" type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" value="{{ $profileData->phone }}">
                    </div>
                    <div class="mb-3">
                    ...
                    {{-- <div class="mb-3">
                    <label for="exampleInputUsername1" class="form-label">Photo URL</label>
                    <input name="photo" type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" value="{{ $profileData->photo }}">
                    </div> --}}
